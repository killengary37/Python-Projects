...
class Developer(Employee):  #1st child class is developer, base pay and language
    ...
    def __init__(self,department)
        self.department = department  #This attribute establishes which department the employee works in
...
class Manager(Employee):    #2nd child class manager, which department and how many employees under them
    ...
    def __init__(self,years_service)
        self.years_service = years_service  #This attribute establishes how long the manager has been with the company
...
dev_1 = Developer('Gary', 'Killen', 60000, 'Python',engineering)
